  ...
  def _CreatePipeline(coprocessor, datadescription):
    class Pipeline:
      ...
      coprocessor.RegisterView(renderView1,
          filename='mpas_T_%t.png', freq=1, fittoscreen=0, magnification=1, width=1283, height=541)
      ...
      coprocessor.RegisterView(renderView2,
          filename='mpas_KE_%t.png', freq=1, fittoscreen=0, magnification=1, width=1283, height=541)
